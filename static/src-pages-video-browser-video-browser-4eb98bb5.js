...
$_mod.def("/video-browser$0/video-browser", function(require, exports, module, __filename, __dirname) { console.log('oh hai there again')

console.log('this is soooo new');
});
$_mod.run("/video-browser$0/video-browser");